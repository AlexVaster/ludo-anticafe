...
<body>
  ...
  <div class="game_block">
    <div class="game_col">
      <div class="game_pic">
        <img src="/image/UnoBig.png" alt="">
      </div>

      <div class="info_block">
        <span class="info_header h2">UNO</span>
        <span class="info_main h5">UNO!<br><br>
        Хотите интересно и весело провести вечер?  Вам потребуется компания друзей, родственников, коллег или, малознакомых людей и колода карт Uno. Главное достоинство этой игры — простые правила. <br><br>
        Благодаря непосредственному контакту между игроками, игра всегда проходит весело, азартно, а главное, каждый раз по-новому.</span>
        <div class="info_more">
          <div class="line_more"></div>
        </div>
        <span class="info_tabletime h3">ВОСКРЕСЕНЬЕ — 16:00<br>ВТОРНИК — 22:00</span>
