...
<body>
  ...
  <div class="game_block">
    <div class="game_col">
      <div class="game_pic">
        <img src="/image/ClassicsBig.png" alt="">
      </div>

      <div class="info_block">
        <span class="info_header h2">ВЕЧЕР КЛАССИКИ</span>
        <span class="info_main h5">Возвращение книжных традиций<br><br>
        Современные поэты будут читать малоизвестные произведения классиков, открывая новые грани творчества Маяковского, Цветаевой, Пастернака.<br><br>
        Каждый из зрителей также сможет подняться на сцену и прочесть любимые или авторские стихотворения.</span>
        <div class="info_more">
