...
<body>
  ...
  <div class="game_block">
    <div class="game_col">
      <div class="game_pic">
        <img src="/image/DominoBig.png" alt="">
      </div>

      <div class="info_block">
        <span class="info_header h2">ДОМИНО</span>
        <span class="info_main h5">Р-р-рыба!!<br><br>
        Здорово, что классическое домино в чёрной пластиковой коробочке не перестали выпускать! Такая ностальгия по временам, когда люди сидели и дома, и в парках, и в кафе — все играли в домино.<br><br>
        У многих дома ещё сохранилось такое домино! А у кого нет — приходите к нам, когда хочется поиграть во что-то простое перед сном, или вдруг надоели сложные настольные игры, домино — отличный вариант.</span>
        <div class="info_more">
          <div class="line_more"></div>
        </div>
        <span class="info_tabletime h3">СУББОТА — 15:00<br>СРЕДА — 14:00</span>
