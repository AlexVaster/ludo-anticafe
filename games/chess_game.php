...
<body>
  ...
  <div class="game_block">
    <div class="game_col">
      <div class="game_pic">
        <img src="/image/ChessBig.png" alt="">
      </div>

      <div class="info_block">
        <span class="info_header h2">ШАХМАТЫ</span>
        <span class="info_main h5">Ход конём!<br><br>
          Шахматы, шашки и нарды - это известнейшие настольные игры. Даже дети знают основные правила и играют в них с огромным удовольствием.<br><br>
          Простота правил привлекает многих, но тем не менее это интеллектуальные игры, призванные включить вашу логику для выстраивания серьезных стратегий на пути к победе над оппонентом.</span>
        <div class="info_more">
          <div class="line_more"></div>
        </div>
        <span class="info_tabletime h3">ПОНЕДЕЛЬНИК — 19:00<br>СРЕДА — 19:00</span>
