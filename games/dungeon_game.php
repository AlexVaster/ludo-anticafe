...
<body>
  ...
  <div class="game_block">
    <div class="game_col">
      <div class="game_pic">
        <img src="/image/DungeonBig.png" alt="">
      </div>

      <div class="info_block">
        <span class="info_header h2">ПОДЗЕМЕЛЬЯ</span>
        <span class="info_main h5">Что тебя ждёт за поворотом?<br><br>
        Отважные герои отправляются в полный опасностей замок древнего вампира, чтобы добыть там славы, сокровищ и, конечно же, приключений на свои бедовые головы. <br><br>
        Сокровища, ловушки и драконы будут поджидать в самых неожиданных местах. Потребуется одновременно стратегическое и тактическое мышление.</span>
        <div class="info_more">
          <div class="line_more"></div>
        </div>
        <span class="info_tabletime h3">ВТОРНИК — 20:00<br>ПЯТНИЦА — 22:00</span>
